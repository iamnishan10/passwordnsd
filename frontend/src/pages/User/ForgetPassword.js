...
export default class ForgetPassword extends Component {
    ...
    handleSubmit = event => {
        ...
        bodyFormData.set('repassword', repassword);
                ...
                <div className="card card-login mx-auto mt-5">
                    ...
                    <div className="card-body">
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="form-group">
                                <div className="form-label-group">
                                    <input type="newpassword" className="form-control" id="inputNewpassword" placeholder="******"  name="newpassword" onChange={this.handleNewpChange} required/>
                                    <label htmlFor="inputNewpassword">New Password</label>
                                </div>
                            </div>
                            <div className="form-group">
                                <div className="form-label-group">
                                    <input type="repassword" className="form-control" id="inputRepassword" placeholder="******"  name="repassword" onChange={this.handleRepChange} required/>
                                    <label htmlFor="inputRepassword">Retype Password</label>
                                </div>
                            </div>

                            <div className="form-group">
                                <button className="btn btn-primary btn-block" type="submit" disabled={this.state.isLoading ? true : false}>Reset Password &nbsp;&nbsp;&nbsp;
                                    {isLoading ? (
